// sub_140019826 @ 0x140019826
#include <stdint.h>
#include <windows.h>

__int64 __fastcall sub_140019826(double *a1, __int64 a2)
{
  int v3; // eax
  ...
  *(double *)&v6 = *a1;
  v9 = 0;
  *(double *)&v5 = *(double *)&v6;
  sub_1400186E8((__int64)&v7, (double *)&v5);
  *(double *)&v5 = *(double *)&v6;
  if ( (unsigned int)sub_14001D6D0(&v5) != 0 )
  ...
  *(double *)&v5 = *(double *)&v6;
  if ( (unsigned int)sub_14001D5E0(&v5) == 1280 )
