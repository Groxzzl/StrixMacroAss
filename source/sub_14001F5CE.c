// sub_14001F5CE @ 0x14001F5CE
#include <stdint.h>
#include <windows.h>

__int64 __fastcall sub_14001F5CE(double a1, _DWORD *a2)
{
  int v3; // eax
  ...
  v9 = 0;
  *(double *)&v5 = a1;
  sub_14001E2CF((__int64)&v6, (double *)&v5);
  if ( (unsigned int)sub_14001D670(a1) != 0 )
  ...
  if ( (unsigned int)sub_14001D560(a1) == 1280 )
