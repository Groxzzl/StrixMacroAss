// sub_14001EFD8 @ 0x14001EFD8
#include <stdint.h>
#include <windows.h>

__int64 __fastcall sub_14001EFD8(__int64 a1, __int64 a2)
{
  __int64 v3; // rax
  _BYTE *v4; // rax
  int v5; // ecx
  ...
  sub_14001D7B0(48, a2);
  sub_14001D7B0(*(_BYTE *)(a2 + 8) & 0x20 | 0x58, a2);
  ...
  sub_14001D7B0(*(_BYTE *)(a2 + 8) & 0x20 | 0x50, a2);
  *(_DWORD *)(a2 + 12) += v23;
  *(_DWORD *)(a2 + 8) |= 0x1C0u;
  if ( *(__int16 *)(a1 + 8) >= 0 )
    v13 = 0;
