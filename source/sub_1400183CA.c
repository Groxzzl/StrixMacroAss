// sub_1400183CA @ 0x1400183CA
#include <stdint.h>
#include <windows.h>

__int64 __fastcall sub_1400183CA(int a1, __int64 *a2, _DWORD *a3)
{
  __int64 v3; // rax
  __int64 v4; // rdx
  void *v5; // rsp
  ...
  if ( a1 == 111 )
    ...
    v25 = 4;
  v22 = sub_140017FB7(2, v25, (__int64)a3);
  ...
  if ( v26 > 0 && (a3[2] & 0x400) == 0 )
  {
    while ( 1 )
    {
      ...
      if ( v17 <= 0 )
        break;
      sub_1400179C0(0x20u, (__int64)a3);
    }
  }
  while ( v21 < v24 )
  {
    v24 = (_QWORD *)((char *)v24 - 1);
    sub_1400179C0(*(char *)v24, (__int64)a3);
  }
  while ( 1 )
  {
